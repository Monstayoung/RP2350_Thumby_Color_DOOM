...
static uint16_t scaled_line[128]; // Scaled line buffer for downsampling
...
void I_InitGraphics(void)
{
    ...
    // SINGLE-CORE MODE: Initialize display on core0
    ...
    // 4. Signal that "core1" is ready
    sem_release(&core1_launch);
    
    // Original multicore code (DISABLED for ARM Secure mode):
