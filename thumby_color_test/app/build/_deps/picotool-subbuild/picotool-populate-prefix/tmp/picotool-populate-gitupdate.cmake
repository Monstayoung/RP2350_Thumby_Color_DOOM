...
execute_process(
  COMMAND "C:/msys64/usr/bin/git.exe" --git-dir=.git show-ref "2.0.0"
  WORKING_DIRECTORY "C:/msys64/home/Q/thumby_color_test/app/build/_deps/picotool-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/msys64/home/Q/thumby_color_test/app/build/_deps/picotool-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/msys64/home/Q/thumby_color_test/app/build/_deps/picotool-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
